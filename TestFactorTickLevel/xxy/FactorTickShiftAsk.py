...
class FactorTickShiftAsk(FactorBase):
...
#        print(Tick_data.keys())
        ...
        ans = ans_ask/ans_priorAsk * Tick_data['T_Volume'].rolling(5, min_periods=3).mean()/Tick_data['T_Volume'].rolling(1, min_periods=1).mean()
