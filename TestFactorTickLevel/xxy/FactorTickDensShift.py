...
class FactorTickDensShift(FactorBase):
...
#        print(Tick_data.keys())
        ...
        ans_shift = Tick_data['T_BidPrice'][-3][-1]/Tick_data['T_BidPrice'][-1][-1]-1
        ans = ans_bid/ans_ask * ans_shift * Tick_data['T_Volume'].rolling(20, min_periods=3).mean()
