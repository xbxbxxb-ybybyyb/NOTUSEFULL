...
def train(label,X,y,score_df,metric='my_score',population_size = 100,parsimony_coefficient='fixed_10_15_1.5_0.1',random_state = 0,max_samples = 0.75,generations = 10,const_range = None):
...
# X_Train,Y_Train,label,info_dict,Minor_List = load_data_list(main_index_code = '000906.SH',index_list = ['000300.SH','000905.SH'],name = 'close',period = 63,zscore_n = 252,t1 = 20140101,t2 = 20221129)
# est_gp,X,y,score_df = train(label,X_Train,Y_Train,Minor_List,metric = 'my_score_fixed_lose',population_size = 20000,parsimony_coefficient='fixed_15_20_4.5_0.1',random_state = random.randint(0,10000),generations = 5,max_samples = 0.7,const_range = (1, 1))
# save_result([info_dict,est_gp])
# train_by_step(est_gp,X,y,score_df,info_dict,step = 5,n_step = 2)
