...
def man(start_date, end_date,sql_config):
    ...
    universe_folder = "/app/data/wdb_h5/WIND/universe_complete/stocklst/"
    ...
    dat_uni = read_data([start_date_old, end_date], columns=['mkt_cap_ard', 'total_shares'], alt = '/app/data/wdb_h5/WIND/MD_CHINA_STOCK_DAILY_WIND/MD_CHINA_STOCK_DAILY_WIND.h5')
