...
class UpdateBarraRisk:
    def __init__(self, sdate, edate, operation='append', universe='alpha_universe', benchmark = 'zz500', 
                            root_path='/app/data/wdb_h5/WIND',parallel=True,md_path=None,fdd_path=None,sql_config=None):
        self.sdate = sdate
        self.edate = edate
        ...
        self.style_path = "/app/data/wdb_h5/WIND/RISK_CHINA_STOCK_DAILY_STYLEFACTOR/RISK_CHINA_STOCK_DAILY_STYLEFACTOR.h5"

        self.descriptor_path = "/app/data/wdb_h5/WIND/RISK_CHINA_STOCK_DAILY_DESCRIPTOR/RISK_CHINA_STOCK_DAILY_DESCRIPTOR.h5"
