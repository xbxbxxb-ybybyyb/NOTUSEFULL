...
class SliceData:
    def __init__(self, code=0, timeStamp=0, nextTimeStamp=0, time=0, bidPrice=0, askPrice=0, bidVolume=0, askVolume=0,
                 lastPrice=0, maxPrice=0, minPrice=0, volume=0, amount=0, totalVolume=0, totalAmount=0,
