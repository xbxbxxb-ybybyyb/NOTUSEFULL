...
def combine_trade_and_capacity(portfolios, start_date, end_date, next_trading_day):
...
def main():
    ...
    start_date = "20190902"
    end_date = "20191115"
    next_trading_day = "20191118"

    combine_trade_and_capacity(portfolios, start_date, end_date, next_trading_day)

    py = Pyfile()
    src_path = "{}/{}-{}_{}/".format(root_path, start_date, end_date, next_trading_day)
    dst_path = "Apollo/cv_info/{}-{}_{}/".format(start_date, end_date, next_trading_day)
