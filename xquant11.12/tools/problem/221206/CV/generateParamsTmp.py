...
def main():
    ...
    next_trading_day = "20191213"
    last_trading_day = "20191212"
    start_date = "20190923"
    end_date = "20191206"
    period = 20

    portfolio_path = "/data/user/666888/Apollo/portfolios/{}/morning/".format(next_trading_day)
    output_path = "/data/user/666888/Apollo/parameters/Apollo_{}_tmp/{}/".format(next_trading_day, portfolio)
    ...
    portfolio_orders = portfolio_orders.fillna(0)
    portfolio_orders = portfolio_orders.sort_values("证券代码")
    # print(portfolio_orders)
    portfolio_codes = portfolio_orders.iloc[100:150, 0].tolist()
    print(portfolio_codes)
    # return
    portfolio_quantities = (portfolio_orders.iloc[250:300, 3] - portfolio_orders.iloc[250:300, 4]).tolist()

    # portfolio_codes = portfolio_codes[0:30]
    # portfolio_quantities = portfolio_quantities[0:30]
