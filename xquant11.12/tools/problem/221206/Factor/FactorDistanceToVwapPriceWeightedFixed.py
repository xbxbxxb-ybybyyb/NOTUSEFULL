...
class FactorDistanceToVwapPriceWeightedFixed(Factor):
    ...
    def calculate(self):
        ...
        if EmaMidPrice <= 0 or ShortMAVolume <= 0 or LongMAVolume <= 0 or SlowMAVolume <= 0:
            ...
            ShortEMAVolume = self.__emaVolumeShort.getLastContent()
            TinyEMAVolume = self.__emaVolumeTiny.getLastContent()
