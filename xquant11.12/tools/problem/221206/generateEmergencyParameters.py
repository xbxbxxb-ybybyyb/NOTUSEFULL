...
def main():
    portfolio = "5161101"
    next_trading_day = "20191031"
    today = "20191030"
    period = 20

    start_date_customized = "20190812"
    end_date_customized = "20191024"

    start_date = "20190701"
    end_date = "20190831"

    portfolio_path = "/data/user/666888/Apollo/emergency_portfolios/"
    output_path = "/data/user/666888/Apollo/emergency_parameters/Apollo_{}/{}/".format(next_trading_day, portfolio)
