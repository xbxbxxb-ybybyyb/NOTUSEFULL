...
class CBDataBroadcaster:
    ...
    def __loadData(self):
        ...
        self.__earlyDataMorning = self.__dataManager.getEarlyDataMorning(self.__stockIndexUASet, False)
        self.__earlyDataAfternoon = self.__dataManager.getEarlyDataAfternoon(self.__stockIndexUASet, False)
        ...
        if self.__splitAdjustedNeeded:
            ...
            self.__earlyDataMorningSA = self.__dataManager.getEarlyDataMorning(self.__stockIndexUASet, True)
            self.__earlyDataAfternoonSA = self.__dataManager.getEarlyDataAfternoon(self.__stockIndexUASet, True)
    ...
    def __generateStartEndIndexAllDict(self):
        ...
        for stock in self.__stockIndexUASet:
            if stock in self.__indexSet:
                ...
                isMockIndex = self.__tickColumnIndexDict1UA["IsMock"]
                isL2PIndex = self.__tickColumnIndexDict1UA["IsL2P"]
            else:
