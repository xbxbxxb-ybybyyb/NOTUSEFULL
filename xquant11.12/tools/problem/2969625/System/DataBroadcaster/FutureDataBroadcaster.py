...
from System.COLUMN_CONFIG import (FUTURE_TICK_COLUMN_INDEX_DICT1, FUTURE_TICK_COLUMN_INDEX_DICT2,
                                  FUTURE_MINUTE_COLUMN_INDEX_DICT, FUTURE_DAILY_COLUMN_INDEX_DICT)
...
class FutureDataBroadcaster:
    ...
    def __init__(self, symbol, stockSet, dataManager):
        ...
        self.__tickColumnIndexDict2 = FUTURE_TICK_COLUMN_INDEX_DICT2
        self.__minuteColumnIndexDict = FUTURE_MINUTE_COLUMN_INDEX_DICT
        self.__dailyColumnIndexDict = FUTURE_DAILY_COLUMN_INDEX_DICT
