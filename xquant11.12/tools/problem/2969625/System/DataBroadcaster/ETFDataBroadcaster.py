...
from System.COLUMN_CONFIG import (ETF_TICK_COLUMN_INDEX_DICT1, ETF_TICK_COLUMN_INDEX_DICT2,
                                  ETF_MINUTE_COLUMN_INDEX_DICT, ETF_DAILY_COLUMN_INDEX_DICT)
...
class ETFDataBroadcaster:
    ...
    def __init__(self, symbol, stockSet, dataManager):
        ...
        self.__tickColumnIndexDict2 = ETF_TICK_COLUMN_INDEX_DICT2
        self.__minuteColumnIndexDict = ETF_MINUTE_COLUMN_INDEX_DICT
        self.__dailyColumnIndexDict = ETF_DAILY_COLUMN_INDEX_DICT
