...
STOCK_RAW_TRANSACTION_COLUMNS = ["MDDate", "MDTime", "TradeBuyNo", "TradeSellNo", "TradeType", "TradeBSFlag", "TradePrice", "TradeQty", "TradeMoney"]
STOCK_CLEAN_TRANSACTION_COLUMNS = [ "Timestamp", "MDDate", "MDTime", "TradeBuyNo", "TradeSellNo", "TradeType", "TradeBSFlag", "TradePrice", "TradeQty", "TradeMoney"]
STOCK_TARGET_TRANSACTION_COLUMNS = [ "Timestamp", "Date", "Time", "BidOrder", "AskOrder", "TradeType", "BSFlag", "Price", "Volume", "Amount"]
...
ALIGN_STOCK_TICK_COLUMNS = ["Code", "Timestamp", "Date", "Time", "PreviousClose", "OpenPrice", "HighPrice", "LowPrice", "MaxPrice", "MinPrice", "LastPrice", "Volume", "Amount", "TotalVolume", "TotalAmount", "NumTrades",
                             "BidQty", "OfferQty", "AvgBidPrice", "AvgOfferPrice",
                            "AskP0", "AskP1", "AskP2", "AskP3", "AskP4", "AskP5", "AskP6", "AskP7", "AskP8", "AskP9",
                            "AskV0", "AskV1", "AskV2", "AskV3", "AskV4", "AskV5", "AskV6", "AskV7", "AskV8", "AskV9",
                            "AskN0", "AskN1", "AskN2", "AskN3", "AskN4", "AskN5", "AskN6", "AskN7", "AskN8", "AskN9",
                            "BidP0", "BidP1", "BidP2", "BidP3", "BidP4", "BidP5", "BidP6", "BidP7", "BidP8", "BidP9",
                            "BidV0", "BidV1", "BidV2", "BidV3", "BidV4", "BidV5", "BidV6", "BidV7", "BidV8", "BidV9",
                            "BidN0", "BidN1", "BidN2", "BidN3", "BidN4", "BidN5", "BidN6", "BidN7", "BidN8", "BidN9",
                            "TSIndex", "TEIndex", "OSIndex", "OEIndex", "IsMock"]

ALIGN_CBOND_TICK_COLUMNS = ALIGN_STOCK_TICK_COLUMNS
ALIGN_FUND_TICK_COLUMNS = ALIGN_STOCK_TICK_COLUMNS
TICK_ARRAY_FORMAT_COLUMNS = ["AskPrice", "BidPrice", "AskVolume", "BidVolume"]
...
# Tick Data Clean Time Range
TICK_CLEAN_OPEN_TIME = "093000000"
TICK_CLEAN_MORNING_START_TIME = "093015000"
TICK_CLEAN_MORNING_END_TIME = "112959999"
TICK_CLEAN_AFTERNOON_START_TIME = "130015000"
TICK_CLEAN_AFTERNOON_END_TIME = "145659999"