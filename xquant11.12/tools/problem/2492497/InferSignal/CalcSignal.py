...
import pandas as pd
from Utils.HelpFunc import get_trading_day
from xquant.factordata import FactorData
from InferSignal.InferModel import InferModel
        ...
        try:
            ...
            for factor_library, save_library in zip(self.factor_library_list, self.save_library_list):
                ...
                if not os.path.exists(model_path):
                    raise Exception(" Model Not Found at {} For {} ".format(model_path, self.code))
