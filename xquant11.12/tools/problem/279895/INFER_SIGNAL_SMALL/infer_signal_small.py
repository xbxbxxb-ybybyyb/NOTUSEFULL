...
def infer_signal(signalPath, absolutePath, libraryName, factorNames, tagNames, tagDict, test_start_date, test_end_date,
    ...
    for i in range(len(code)):
        ...
        # log_fd.logger.debug("factors: %s", factorNames)
        ...
        try:
            ...
            for test_date in test_date_list:
                try:
                    ...
                    #factor_tag_timestamp_df.to_csv("{}/{}.csv".format(stock_code, test_date))
                    factor_tag_timestamp_df.read_csv("{}/{}.csv".format(stock_code, test_date))
...
#                    factor_data.update_factor_value("ModelSmallTest", dt_frame, stock_code, date)
