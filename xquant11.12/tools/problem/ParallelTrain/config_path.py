...
model_root_path = '/data/group/800020/AlphaDataCenter/Department/'#'Experiment/TestUpdateModel/'
...
factor_custom_path = '/data/user/012620/AlphaData/factor_custom_dict_shp.pkl'#'/data/user/012620/AlphaData2/factor_custom_dict_862.pkl'#
...
model_config_dict = {
           ...
           'vwap':[
               ...
               ('DeepFM_500','vwap','vwap_re_5d',5,240)],
           'vwap300':[
