...
import copy
import numpy as np
import DataAPI.ExchangeHouse.Data.ReadDataFile as readData
...
class SingleStockData:
    ...
    def get_position(data, tick_num):
        ...
        try:
            result_list[0, 0] = round(data['AskP10'][tick_num], 3)
            result_list[1, 0] = round(data['AskP9'][tick_num], 3)
            result_list[2, 0] = round(data['AskP8'][tick_num], 3)
            result_list[3, 0] = round(data['AskP7'][tick_num], 3)
            result_list[4, 0] = round(data['AskP6'][tick_num], 3)
            result_list[5, 0] = round(data['AskP5'][tick_num], 3)
            result_list[6, 0] = round(data['AskP4'][tick_num], 3)
            result_list[7, 0] = round(data['AskP3'][tick_num], 3)
            result_list[8, 0] = round(data['AskP2'][tick_num], 3)
            result_list[9, 0] = round(data['AskP1'][tick_num], 3)
            result_list[10, 0] = round(data['BidP1'][tick_num], 3)
            result_list[11, 0] = round(data['BidP2'][tick_num], 3)
            result_list[12, 0] = round(data['BidP3'][tick_num], 3)
            result_list[13, 0] = round(data['BidP4'][tick_num], 3)
            result_list[14, 0] = round(data['BidP5'][tick_num], 3)
            result_list[15, 0] = round(data['BidP6'][tick_num], 3)
            result_list[16, 0] = round(data['BidP7'][tick_num], 3)
            result_list[17, 0] = round(data['BidP8'][tick_num], 3)
            result_list[18, 0] = round(data['BidP9'][tick_num], 3)
            result_list[19, 0] = round(data['BidP10'][tick_num], 3)
