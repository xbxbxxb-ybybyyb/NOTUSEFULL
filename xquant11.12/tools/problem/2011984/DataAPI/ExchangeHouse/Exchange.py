...
from DataAPI.ExchangeHouse.Match import Match
...
class Exchange:
    ...
    def __init__(self, code, send_delay, back_delay, data_class, is_holo):
        # 撮合类
        self.__match = Match(code, data_class, is_holo)
        # 发送延迟
