import os
import time
import INFER_SIGNAL_BIG.CONFIG_BIG as CONFIG_BIG
from INFER_SIGNAL_BIG.infer_signal_big import infer_signal
...
config = CONFIG_BIG.InferSignalConfig()
...
libraryNameS = config.library_nameS
factorNames = config.factor_names
factorNamesS = config.factor_namesS
