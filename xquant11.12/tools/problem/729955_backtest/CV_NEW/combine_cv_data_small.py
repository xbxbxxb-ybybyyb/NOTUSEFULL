...
def combine_trade_and_capacity(portfolio, start_date, end_date, next_trading_day):
    # shutil.copy("/data/user/015629/ConvertibleBond/CbondPoolManagement/DailyPortfolio/{}/{}_{}.xlsx".format(next_trading_day, portfolio, next_trading_day),
                # "/data/user/666888/WuKong/portfolios/{}_{}.xlsx".format(portfolio, next_trading_day))
    shutil.copy("/data/user/015629/ConvertibleBond/CbondPoolManagement/ConcatPortfolio/{}/{}_{}.xlsx".format(next_trading_day, portfolio, next_trading_day),
                "/data/user/666888/WuKong/portfolios/{}_{}.xlsx".format(portfolio, next_trading_day))
...
def main():
    ...
    dst_path = "WuKong/bt_info/{}-{}_{}/{}/".format(start_date, end_date, next_trading_day, portfolios)
