            ...
            for j in range(len(detailedOrders[i])):
                for k in range(len(DetailedOrdersTitleList)):
                    if k == 0:
                        ...
                        if DetailedOrdersTitleList[k] == "orderAmount" or DetailedOrdersTitleList[k] == "cumAmount" or DetailedOrdersTitleList[k] == "quantity" or DetailedOrdersTitleList[k] == "cumQty":  
