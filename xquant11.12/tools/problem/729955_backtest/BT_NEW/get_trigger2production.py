...
replace_all = True
# replace_all = False
input_dir = 'production/cv-20200701-20200831_20200831-WuKong-40-80_big_cb_20200701_20200918_pure/'
py = Pyfile()
index = input_dir.index('/cv')
sub_str = input_dir[index + 1: ]
name = sub_str.split('/')[0]
output_dir = 'production_triggers/big_cb_20200701_20200918_pure/'
if replace_all:
