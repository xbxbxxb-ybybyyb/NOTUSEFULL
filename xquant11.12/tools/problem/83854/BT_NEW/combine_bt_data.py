...
def combine_bt_data(is_copy_to_share):
    ...
    if is_copy_to_share:
        ...
        for portfolio in portfolios:
            ...
            # print(dt.datetime.now(), "Copying {}'s trade and trigger to shared directory...".format(portfolio))
            # py.copyToShare(
                # '$21/ModelProduction/' + model_prefix + '/bt_info/{}-{}/{}/'.format(today_str, today_str, portfolio),
