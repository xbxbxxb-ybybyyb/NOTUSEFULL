...
def store_data(code, absolutePath, factorAddress, pid=0):
    ...
    log_file_path = "/data/user/Logging/storeH5Factor/{}".format(today_str) +"_"+str(pid)
    ...
    log_fd.logger.debug("start to store h5 factor")
    ...
    for i in range(total): 
        ...
        # if not os.path.exists(file_name):
            ...
            try:  
                ...
                tradingUnderlyingCode = []
                factorName = []
                log_fd.logger.debug("stock {} saved, having stored {} stocks of totaly {}".format(stock_code, i, total))

            except Exception as e:
 #               print(e)
#                log_fd.logger.debug("update " + str(i) + "th " + stock_code + " failed!")
                log_fd.logger.debug("update " + str(i) + "th " + stock_code + " failed because of {}!".format(e))
