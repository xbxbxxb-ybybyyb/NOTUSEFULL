...
class BacktestConfig:
    def __init__(self):
        ...
        self.trade_portfolio =  "5161101+800"
    ...
    def _load_portlio_from_ftp(self):
        ...
        print("Total Trading stocks:", len(trade_codes))
        print("Total zz800 stocks:", len(zz800_codes))

        self.codes = list(set(trade_codes).union(set(zz800_codes)))
        print("Total union stocks:", len(self.codes))
