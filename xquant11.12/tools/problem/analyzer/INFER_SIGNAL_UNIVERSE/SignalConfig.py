...
class InferSignalConfig:
    def __init__(self):
        self.test_start_date = "20201009"
        self.test_end_date = "20201009"
        self.next_trading_day = "20200724"

        self.model_name = "20200313"
        self.model_path = "/data/user/015629/chensf/1.4.0_big_easy_20201001_1019/universe/"
        self.signal_library = "Separate1019UniverseSignals"
