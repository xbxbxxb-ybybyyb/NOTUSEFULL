...
def infer_signal(signalPath, logPath, absolutePath, libraryName, signalLibrary, factorNames, factorIndex, tagNames, tagDict, test_start_date,
...
def main():
    from INFER_SIGNAL_FEATURE.SignalConfig import InferSignalConfig
    ...
    if is_multiprocess:
        ...
        for code in codeList:
            pool.apply_async(infer_signal, (signalPath, logPath, absolutePath, libraryName, signalLibrary, factorNames, factorIndex, tagNames, tagDict, test_start_date,
                 test_end_date, [code], pid, ))
        pool.close()
        pool.join()

    else:
        infer_signal(signalPath, logPath, absolutePath, libraryName, signalLibrary, factorNames, factorIndex, tagNames, tagDict, test_start_date,
                 test_end_date, codeList, pid)
