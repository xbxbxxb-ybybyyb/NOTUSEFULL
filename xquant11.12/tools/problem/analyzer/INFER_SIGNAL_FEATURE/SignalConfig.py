...
class InferSignalConfig:
    def __init__(self):
        ...
        self.test_start_date = "20210119" # pre_trading_day
        self.test_end_date = "20210121" # pre_trading_day
        self.next_trading_day = today

        self.model_name = "20200313"
        self.model_path = "/data/user/015629/chensf/new_easy_20201001_20201019/"
        self.signal_library = "EasySeparate1019Features"   ### Signal Library
        ...
        # validStockList = FactorData().search_by_date(self.signal_library, self.test_end_date, stockList)
