...
def run_bt():
    ...
    trade_portfolio = ["hs300_Track", "zz500_Track"]
    start_date = "20200506"
    end_date = "20200930"
    cv_start_date = "20200301"
    cv_end_date = "20200430"
    cv_next_date = "20200506"
    csv_param_date = "20200506"
    hs300 = False
    zz500 = False
    ...
    for portfolio in trade_portfolio:
        ...
        signal_csv_dir = "EasySimpleUniqueKCFilter" # "Separate1019ModelSignals"
