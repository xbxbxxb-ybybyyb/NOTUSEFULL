...
class InferSignalConfig:
    def __init__(self):
        ...
        pre_trading_day = self.fa.tradingday(today, -1)[0]
        ...
        self.model_path = "/data/user/015629/chensf/Easy_20201001/"
        self.signal_library = "Easy_20201001"
        ...
        # stockList = pd.read_excel("/data/user/015629/StockPool/full_easy_small_model.xlsx")["stock"].tolist()
        stockList = os.listdir(self.model_path)
