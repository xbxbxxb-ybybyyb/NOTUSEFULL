...
class InferSignalConfig:
    def __init__(self):
        self.test_start_date = "20201228"
        self.test_end_date = "20201228"
        self.next_trading_day = "20200724"

        self.model_name = "20200313"
        self.model_path = "/data/user/015629/chensf/1.4.0_small_easy_20201001/"
        self.signal_library = "small_easy_20201001"
        ...
        # validStockList = self.fa.search_by_date(self.signal_library, self.test_end_date, stockList)
        # self.code_list = list(set(stockList).difference(validStockList))
        # hs300 = pd.read_excel("/data/user/666888/AlgoGenzong2/portfolios/hs300.xlsx").iloc[:, 0].tolist()
        # zz500 = pd.read_excel("/data/user/666888/AlgoGenzong2/portfolios/zz500.xlsx").iloc[:, 0].tolist()
        small_model_list = np.random.choice(os.listdir(self.model_path), 100).tolist()
        self.code_list = small_model_list
        ...
        self.factor_names = ['factorMAVolumeDistance10_20', 'factorTransBuyVolumeDistance5_40', 'factorDistanceToHigh100',
...
if __name__=="__main__":
    ...
    print(len(config.factor_name_list))
