...
def man(start_date, end_date,sql_config):
    ...
    sql_use = "select distinct S_INFO_WINDCODE,ANN_DT,S_DIV_PROGRESS,CASH_DVD_PER_SH_PRE_TAX,EX_DT from %s where ANN_DT >= %s and ANN_DT <= %s"%(table,sdate_dummy,edate_dummy)
