...
# from multifactor.IO_enums import *
...
h5_path_listing_delisting = '/app/data/wdb_h5/WIND/AShareDescription/AShareDescription.h5'
...
def backfill(start_date, end_date, factor_qtr_pd, issuing_date_ps=None, trading_date_list=None,
    ...
    # modify 删除fillna
    data.fillna(pd.Timestamp('20100108'),inplace=True)
    ...
    print("+++"*30)
    print(data.columns)
    print(listing_delisting_filter)
    ...
    # modify 删除fillna
    data.fillna(0.9999999999,inplace=True)
...
def get_backfill_prep(sdate,edate,announce_date=None):
    ...
    if announce_date is not None:
        ...
        # modify
        alt_QUARTERLY = "/app/data/wdb_h5/WIND/FDD_CHINA_STOCK_QUARTERLY_WIND/FDD_CHINA_STOCK_QUARTERLY_WIND.h5"
