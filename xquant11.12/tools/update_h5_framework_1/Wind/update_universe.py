...
def updater_universe_csv(cdate_list,sql_config):
    ...
    store_path = "/app/data/wdb_h5/WIND_TEST/universe_complete/csvlst/"
    # listing date
...
def create_universe_v2(sdate, edate, h5_path,sql_config):
    ...
    alt_path = '/app/data/wdb_h5/WIND_TEST/MD_CHINA_STOCK_DAILY_WIND/MD_CHINA_STOCK_DAILY_WIND.h5'
...
class unv_factor(object):
    ...
    def csv_to_database(self):
        csv_path = "/app/data/wdb_h5/WIND_TEST/universe_complete/csvlst/"
        source_table = "universe_complete"
        destination_table = "UNIV_CHINA_STOCK_DAILY_OPTM"
        h5_path = "/app/data/wdb_h5/WIND_TEST/"
