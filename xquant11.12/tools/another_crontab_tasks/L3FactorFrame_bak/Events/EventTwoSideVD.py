...
class EventTwoSideVD(FactorBase):
            ...
            for i in list(range(L-1))[::-1]:
                ...
                if isEqual(currentAskP0, localAskP0) \
                    ...
                    if CONTINUOUS_CALC_FLAG:
                        ...
                        elif lessThan(localAskV0, lastAskV0) or greaterThan(localBidV0, lastBidV0):
                ...
                if isEqual(currentAskP0, localAskP0) \
                    ...
                    if CONTINUOUS_CALC_FLAG:
                        if greaterThan(localBidV0, lastBidV0):
                            ...
                            lastAskV0 = localAskV0
                        elif lessThan(localBidV0, lastBidV0) or greaterThan(localAskV0, lastAskV0):
                            CONTINUOUS_CALC_FLAG = False
                else:
                    return False
        return False
