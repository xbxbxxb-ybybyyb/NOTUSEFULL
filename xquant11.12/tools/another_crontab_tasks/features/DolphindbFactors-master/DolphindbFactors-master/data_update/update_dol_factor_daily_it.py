...
def create_factor_config(factor_list=None):
    res_dict = {}
    a = open("factor_config_it.json", 'w')
    ...
    a.close()
    print("配置文件：factor_config_it.json 已生成！")
...
def update_factordata(start_date, end_date, target_securities=None, return_mode="show",
    ...
    config_path = "./factor_config_it.json"
...
def main(target_securities, start_date, end_date, factor_list=None):
    ...
    non_factor_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../factors/InfoTech/StockMMRetV1NoneFactor"))
