    ...
    if len(sh_stocks)>0:
        ...
        for stock in sh_stocks:
            ...
            if sh_res_temp.shape[0]>0:
                fp.save_public_data_to_dfs(sh_res_temp, factor_type='factor', data_type="enhanced_tick_norm")
    ...
    if len(se_stocks)>0:
        ...
        for stock in se_stocks:
            ...
            if se_res_temp.shape[0]>0:
                fp.save_public_data_to_dfs(se_res_temp, factor_type='factor', data_type="enhanced_tick_norm")
    return
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--start_date', default="20240102", type=str, help='input the start date')
    parser.add_argument('-e', '--end_date', default="20240102", type=str, help='input the end date')
