...
class L2PXGBoostRegPack:
    ...
    def train_loop(self, model_params):
        ...
        for symbol in symbol_list:
            ...
            T_train_list.append(T_train[-12000000:])
            X_train_list.append(X_train[-12000000:])
            Y_train_list.append(Y_train[-12000000:])
        ...
        for path in ["signal_all.xlsx"]:
            ...
            for symbol_name in self.model_config["symbol_list"]:
                try:
                    ...
                    save_backtest_result(result_agg_df, symbol_name, output_path=excel_path.replace("signal_all", "signal_all_agg").replace("signal_sample", "signal_sample_agg"))
                except Exception as e:
                    print(e)
                    pass
        ray.shutdown()
...
if __name__ == "__main__":
    ...
    if stock_set == "kc50":
        ...
        symbols1 = [s for s in symbols1 if s.startswith("688")]
