...
def winloss_func(source_signal_df, long_pred_th, short_pred_th, start_date="2023-12-06", end_date="2024-02-06", use_self_prob = False):
...
for symbol in ["688012.SH", "688041.SH"]:
    ...
    for date in tqdm(dates):
        ...
        eva_dict = winloss_func(signal_df.copy(), long_pred_th, short_pred_th,
