...
if __name__=="__main__":
    ...
    symbols = [
               ...
               # #   '300724.SZ',
               # #   '002432.SZ',
        '000538.SZ', '000623.SZ', '000625.SZ', '000792.SZ',
        '603000.SH', '603005.SH', '603083.SH', '603108.SH',
        '688047.SH',
               # '688390.SH',
                 '688506.SH',
               # '688032.SH',
    ...
    dates = fa.tradingday("20240401", "20240631")
    now_date = datetime.now().strftime("%Y%m%d")
    dates = [date for date in dates if now_date>=date][:1]
    print(symbols)
    print(dates)
    # dates = ["20240520"]
    # symbols = ["688981.SH"]
    ...
    for symbol in symbols:
        for date in dates[::-1]:
            tasks.append(remote_func.remote(symbol, date, source_factor_config,
                                            factor_path, event_path, save_base_dir = save_base_dir))
    ray.get(tasks)
