...
def get_l3_trade_order_data(symbol, date, merge_one_order = True, base_dir="/dfs/group/800657/library/l3_data"):
    try:
...
def calc(symbol, date):
    l3_df, order_df, trade_df, cancel_df = get_l3_trade_order_data(symbol, date, merge_one_order = True)
