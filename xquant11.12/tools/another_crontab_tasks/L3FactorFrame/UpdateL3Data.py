...
def UpdateL3Data(stock_code, trade_date):
    try:
...
if __name__ == "__main__":
    ...
    if local_mode:
        ...
        ray.init()
        fa = FactorData()
        # symbols = fa.hset("INDEX", "20240130", "000688.SH")["stock"].tolist()
        symbols = ["688041.SH", "688256.SH", "688012.SH", "688981.SH", "688111.SH", "688271.SH"]
