...
class FacOneBigOrder(FactorBase):
    ...
    def calculate(self):
        ...
        if isEqual(tickDataIndex, 1351577):
            a = 1
                ...
                if isEqual(tickDataIndex, orderIndex):
                    if isEqual(orderBSFlag, 1):
                        if isEqual(currentTickAskP0, lastTickAskP0) \
                            ...
                            factorValue = (lastTickAskV0 - currentTickAskV0)/askv0_quantile
                        ...
                        if isEqual(currentTickBidP0, lastTickBidP0) \
                            ...
                            factorValue = -(lastTickBidV0 - currentTickBidV0)/bidv0_quantile
