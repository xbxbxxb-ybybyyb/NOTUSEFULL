...
class FacCumOrdersNetVolOverV0(FactorBase):
    ...
    def calculate(self):
        ...
        # if isEqual(tickDataIndex, 932010):
        #     print("debug")
        ...
        if isEqual(tickDataIndex, 497726):
            a = 1
                    ...
                    if isEqual(orderBSFlag, 1):
                        ...
                        if isEqual(currentTickAskP0, lastTickAskP0) \
                            ...
                            if equalGreaterThan(netBidVolume, currentTickAskV0) \
                                ...
                                factorValue = netBidVolume/askv0_quantile
                        ...
                        if isEqual(currentTickBidP0, lastTickBidP0) \
                            ...
                            if (equalGreaterThan(netAskVolume, currentTickBidV0)
                                ...
                                factorValue = -netAskVolume/bidv0_quantile
