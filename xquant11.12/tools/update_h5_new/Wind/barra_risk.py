...
def execute(date,sql_config):
    ...
    sdate = edate = date
    md_path = "./md_20190702_20190702.pkl"
    fdd_path = "./fdd_20190702_20190702.pkl"
    self = UpdateBarraRisk(sdate, edate, sql_config=sql_config,md_path=md_path,fdd_path=fdd_path)
    self.read_data()
    self.launch()

#if __name__ == '__main__':
#    freeze_support()
#    execute(20190702,'sql_config')
