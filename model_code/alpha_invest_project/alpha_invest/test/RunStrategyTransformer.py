...
def main():
    ...
    # 上传工程配置参数
    factor_name = instance.dataset_config.pop("factor_name")
    log_params(instance.dataset_config)
    log_params(instance.model_config["model_params"])
    instance.dataset_config['factor_name'] = factor_name
    ...
    trainer = ParallelTrainer(backend=StrategyTransformer,
                              ...
                              ray_params=RayParams(cpus_per_worker=1, gpus_per_worker = 0))
