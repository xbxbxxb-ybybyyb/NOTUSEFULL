        ...
        for inner_key, inner_value in outer_value.items():
            if inner_key == "model_params":
                for key in inner_value:
                    yaml_params['{}_{}'.format("model_params", key)] = inner_value[key]
            if inner_key == "data_params":
                for key in inner_value:
                    yaml_params['{}_{}'.format("data_params", key)] = inner_value[key]
            if inner_key == "task_params":
                for key in inner_value:
                    yaml_params['{}_{}'.format("task_params", key)] = inner_value[key]
