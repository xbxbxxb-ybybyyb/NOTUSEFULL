...
if __name__ == "__main__":
    ...
    p.apply_async(sub_task, args=(20210901, 20210905, 1,))
    p.apply_async(sub_task, args=(20210905, 20210909, 2,))
    p.apply_async(sub_task, args=(20210909, 20210913, 3,))
    p.apply_async(sub_task, args=(20210913, 20210917, 4,))
    p.close()
    p.join()
