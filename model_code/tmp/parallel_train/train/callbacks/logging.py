...
from .results_preprocessors import IndexedResultsPreprocessor, \
    ExcludedKeysResultsPreprocessor
from .results_preprocessors.preprocessor import \
    SequentialResultsPreprocessor
from ..constants import (RESULT_FILE_JSON, TRAINING_ITERATION,
                                 TIME_TOTAL_S, TIMESTAMP, PID,
                                 TRAIN_CHECKPOINT_SUBDIR)
from ray.util.debug import log_once
from ..depends.ml_utils.dict import flatten_dict
from ..depends.ml_utils.json import SafeFallbackEncoder
from ..depends.ml_utils.mlflow import MLflowLoggerUtil
...
class JsonConsoleCallback(TrainingCallback):
    """Logs Train results in json format.
