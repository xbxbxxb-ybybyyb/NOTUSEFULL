...
USE_CMO = {}
params_dict = {'model': {'name': 'xgboost', 'model_type': 'classification', 'model_save_path': None, 'model_param': None}, 'data_depend': {'factor_name': 'ddd', 'factor_path': '/data/user/012620/AlphaExperiment/tmp,/data/user/013150/ai_data/,/data/user/666889/,/data/user/013150/', 'label_name': 'test', 'label_path': '/data/user/013150/tmp', 'other_data_path': None}, 'date_range': {'start_date': 20200101, 'end_date': 20211026}, 'custom_param': None, 'update_model_period': 20}
...
def parse_params(config_path=None):
    ...
    if not params_dict:
        ...
        if os.path.exists(dst):
            try:
                shutil.copyfile(yaml_file,
                                os.path.join(dst, yaml_file.split('/')[-1]))
            except:
                pass
    return params_dict
