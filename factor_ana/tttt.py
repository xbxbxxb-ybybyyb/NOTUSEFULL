...
def update_consensus_data(sdate=None,edate=None,operation='append'):
    ...
    table_list = [
                   'con_forecast_stk', 
                  'con_forecast_schedule',
                    'stock_order3','stock_report_adjustment',
                  ...
                  'stock_diversity','stock_emotion','stock_report_extremum', 'der_report_subtable', 
                  'cmb_report_score_adjust', 
                  'i_organ_score','report_author', 'cmb_report_adjust', 'gg_org_list', 'i_report_type', 'author_core_type', 'author_core',
    ...
    table_list3 = [
                    'researcher_info', 'author_core', 'author_core_type', 'i_report_type', 't_author_honor',
    ...
    root_path = '/data/group/800080/warehouse/prod/BAK/'
...
#            retrieve(table_name, cdate_list,root_folder)
        ...
        if table_name not in ['cmb_report_research','der_report_research','author_pj','change_type','change_event']:
            if table_name =='con_forecast_stk':
                ...
                h5_root = root_path + 'SUNTIME/'+ table_name + '/'
                if not os.path.exists(h5_root):
                    os.makedirs(h5_root)
...
if __name__ == '__main__':
    sdate,edate = 20200818, 20200818
#    flag_root = '/data/group/800080/warehouse/prod/LOCAL_DATA/FLAG/' + str(edate) + '/'
    
#    flag_path_start = flag_root + str(edate) + '_' + 'SUNTIME.start'
...
#    flag_path_success = flag_root + str(edate) + '_' + 'SUNTIME.success'
...
#        pass
    ...
    logger.info('update concensus htsc complete!') 
