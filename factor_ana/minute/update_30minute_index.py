...
def MD_retrieve(date):
    root = '/data/group/800080/warehouse/prod/LOCAL_DATA/CSV/wind_data/index/'
    path = '/data/group/800080/warehouse/prod/LOCAL_DATA/CSV/WIND/MINUTE/index_perdate/'
...
def rolling(sdate=None, edate=None):
    ...
    csv_path = '/data/group/800080/warehouse/prod/LOCAL_DATA/CSV/wind_data/index/'
    h5_path = r'/data/group/800080/warehouse/prod/VD/CHINA_INDEX/DAILY/WIND/VD_CHINA_INDEX_DAILY_WIND.h5'

    update_wind_daily_h5(cdate_list,factor_list +factor_list2,csv_path,h5_path,operation='append')
...
def update_30minute_index(a = None, b = None):
    ...
    flag_path_success = flag_root + str(edate) + '_' + 'VD2.success'
