...
class FactorOrderImbalance_level1 : public Factor<> {

public:
  FactorOrderImbalance_level1() { type_ = __func__; }
  ...
  Status caculate() override {
    ...
    auto buy1_qty = current_tick_bid_v[1];
    auto buy1_price = current_tick_bid_p[1];
    auto ask1_qty = current_tick_ask_v[1];
    auto ask1_price = current_tick_ask_p[1];
