...
class FactorGuangFaTechIndicatorAPZ_n_tick10 : public Factor<> {
  static const int SHORT_SECONDS = 30;
  static const int LONG_SECONDS = 60;

  TimeSlidingWindow<double> short_window_list{SHORT_SECONDS};
  TimeSlidingWindow<double> long_window_list{LONG_SECONDS};

public:
  FactorGuangFaTechIndicatorAPZ_n_tick10() { type_ = __func__; }
