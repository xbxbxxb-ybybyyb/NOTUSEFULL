...
public:
  ...
  Status caculate() override {
    ...
    value() = mstd_sum_sell_num > 1e-6 ? mstd_sum_buy_num / mstd_sum_sell_num : 0;
    return Status::OK();
  }
};
