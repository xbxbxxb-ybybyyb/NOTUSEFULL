...
log_level='INFO'
log_path = '/data/group/800080/warehouse/test/LOCAL_DATA/LOG/WIND/MINUTE/'
...
def parallel_io(func, ticker_list, *args, date_list, max_workers=15, **kwargs):
    tic = time.time()
...
def update_wind_minute(sdate=None, edate=None, use_len=20, operation='append'):
    ...
    parallel_io(update_minute_pickle, ticker_list, date_list=cdate_list, max_workers=15,
