...
def first_job(sdate=None,edate=None):
    ...
    daily_list2 = ['WIND_AShareStaff','WIND_AShareIPO','WIND_AShareSEO',
                    'WIND_AShareMjrHolderTrade','WIND_AShareRightIssue']
    
    qtr_list2 = ['WIND_AShareSalesSegment','WIND_AShareFinancialExpense','WIND_AShareAuditOpinion',
                'WIND_AShareIBrokerIndicator','WIND_AShareBankIndicator','WIND_AShareInsuranceIndicator']
    
    table_dict = {'QUARTERLY': qtr_list + qtr_list2, 'DAILY': first_daily_list + daily_list2}
    # table_dict = {'QUARTERLY': [], 'DAILY': ['WIND_AShareIndustriesClassCITICS']}
