...
connstr = 'center_read/Htsc.Htzx2012@168.11.241.223:1521/zxdw'
...
sql = 'select * from center_admin.pub_personmain'
...
sql = """insert into text_basicinfo(id,mediacode,medianame,textcategory,pubdate,writingdate,texttitle,subtitle,keywords,comcode,comname,authors,reportlevel,infolevel,entrytime,updatetime,groundtime,resourceid,recordid,workno,status,reportid,updateid,rank,expirationdate) 
VALUES ({},{},{},{}, {}, {},{},{},{}, {}, {},{},{},{}, {}, {},{},{},{}, {}, {},{},{},{}, {})
...
import time
#time.sleep(500)
for table in [ 'tasset', 'tcombi', 'tfundinfo']:#['exchangeorder', 'execution', 'position', 'fund', 'positionext', 'tstockinfo', 'tasset', 'tcombi', 'tfundinfo']:
    sql = 'select * from {} limit 200000'.format(table)
    df = pd.read_sql(sql, conn)
    print(table, df)
    df.to_parquet('/data/user/013150/tmp/tmp/{}.pqt'.format(table))
