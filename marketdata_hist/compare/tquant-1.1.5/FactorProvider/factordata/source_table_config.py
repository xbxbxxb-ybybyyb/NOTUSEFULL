...
conforecast_config = {"schema": "xquant_gogoal",
                      "factor_info": {"rating_up_number7": ["rating_up_number7", "stock_report_adjustment2"],
                                      ...
                                      'cfc3i_cgb':["CGB", "con_forecast_c3_idx"],
                                      'cfc3i_cgg': ["CGG", "con_forecast_c3_idx"],
                                      'cfc3i_cgpb':["CGPB","con_forecast_c3_idx"],
                                      'cfc3i_cgpeg':["CGPEG","con_forecast_c3_idx"],
                                      'cfc3i_tdate':["TDate","con_forecast_c3_idx"],
                                      'cfsw_c12':["C12", "con_forecast_sw"],
                                      'stock_diversity': ["Diversity", "stock_diversity"],
                                      'tcap':['TCap',"stock_order2"],
                                      },
                      "table_index": {"con_forecast_schedule": "stock_code as tradingcode,tdate,",
                                      "con_forecast_c3_idx": "stock_code as tradingcode,tdate,",
                                      ...
                                      "stock_order2": "stock_code as tradingcode,tdate,",
...
table_map_factors = {
    ...
    "trade_status": ["factor_vip_financialanalysis_part4", "tradeDate"],
    "premiumrate_ah": ["factor_vip_financialanalysis_part4", "tradeDate"],  # AH股溢价率
    "codechangedate": ["factor_vip_financialanalysis_part4", "tradeDate"],  # 证券代码变更日期
    "precode": ["factor_vip_financialanalysis_part4", "tradeDate"],  # 证券曾有Wind代码
    "trade_code": ["factor_vip_financialanalysis_part4", "tradeDate"],  # 证券代码
    "maxup": ["factor_vip_financialanalysis_part4", "tradeDate"],  # 涨停价
    "maxdown": ["factor_vip_financialanalysis_part4", "tradeDate"],  # 跌停价
    "concept": ["factor_vip_financialanalysis_part4", "tradeDate"], #所属概念板块
    "free_float_shares": ["factor_vip_financialanalysis_part4", "tradeDate"], #自由流通股本
    "total_shares": ["factor_vip_financialanalysis_part4", "tradeDate"], #总股本
    "float_a_shares": ["factor_vip_financialanalysis_part4", "tradeDate"], #流通A股
    "turn": ["factor_vip_financialanalysis_part4", "tradeDate"], #换手率
    "free_turn": ["factor_vip_financialanalysis_part4", "tradeDate"], #换手率（基准.自由流通股本）
    "susp_reason": ["factor_vip_financialanalysis_part4", "tradeDate"], #停牌原因
...
table_map_factors_us = {
    "close": ["factor_vip_us_market", "tradeDate"],  # 收盘价
    "adjfactor": ["factor_vip_us_market", "tradeDate"],  # 复权因子
    "industry": ["factor_vip_us_market", "tradeDate"],  # 行业
    "high": ["factor_vip_us_market", "tradeDate"],  # 最高价
    "open": ["factor_vip_us_market", "tradeDate"],  # 开盘价
    "low": ["factor_vip_us_market", "tradeDate"],  # 最低价
}
