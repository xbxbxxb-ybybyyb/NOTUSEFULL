...
from MDCDataProvider.bonddata.bond2 import BondDataDP
...
class BondData:
    ...
    def get_cfe_bond_data(self, symbol, start_time, end_time, bar_size):
        """
        获取CFE债券数据
        :param symbol: 可转债代码, string类型, 如'123021.SZ'
        :param start_time:起始日期,string类型，如'20190102 000000000'
        ...
        :return:
        """
        return self.bond_dp.get_cfe_bond_data(symbol, start_time, end_time, bar_size)
