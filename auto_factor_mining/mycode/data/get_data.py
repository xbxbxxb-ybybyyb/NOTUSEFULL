...
from gplearn_my.tests.customized_utils import Normalization2
...
if __name__ == '__main__':
    ...
    deacp_save_path = save_path+"decap_file.parquet"
    decap = make_decap(trading_day, stock_list, setup_json['stock_sample_day'], deacp_save_path)
    print("save decap_file to {} , consume time = {} s" .format(deacp_save_path, time.time() - start_time))
