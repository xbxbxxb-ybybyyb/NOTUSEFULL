...
def MyPrint(strings, log_file):
    print(strings)
    with open(log_file, 'a', encoding='utf-8') as f:
        print(strings, file=f)

#log_file = '/data/user/000054/wenhuzhang/project_backup/tagL_transformer_adam_1024_0.0001_debug1/log_filexxx.txt'
#MyPrint(';;;ahsdfjsbha', log_file)
#MyPrint(';;;xxxxxxx', log_file)