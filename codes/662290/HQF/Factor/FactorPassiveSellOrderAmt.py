...
@author: 006566 郑润泽
OrderEvaluate中提取虚拟委托订单，汇总新增卖委托金额，对于高于上个Tick中间价的，即认为是消极委托
"""

from System.Factor import Factor


class FactorPassiveSellOrderAmt(Factor):
        ...
        if midPrice.__len__() >= 2:
            ...
            if OrderBookTmp[-1].__len__() > 0:
                for i_order in OrderBookTmp[-1]:
                    if i_order[3] == 'S' and i_order[1] > lastMidPrice:
                        factorValue += (i_order[1] * i_order[2])
        else:
            factorValue = 0
