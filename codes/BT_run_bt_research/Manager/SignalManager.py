...
from DataAPI.SimpleDataConverter import SimpleDataConverter
...
class SignalManager:
    ...
    def __get_dates(self) -> None:
        with py.open('{}/{}/Dates.json'.format(self.__bt_dir, self.__symbol), 'rb') as f:
            data = f.read()
    ...
    def load_stock_data_in_pickle(self):
        path = '{}/{}/Data.pickle'.format(self.__bt_dir, self.__symbol)
        with py.open(path, 'rb') as f:
            data = f.read()
    ...
    def __load_order_capacity(self):
        with py.open('{}/{}/OrderCapacity.json'.format(self.__bt_dir, self.__symbol), 'rb') as f:
            data = f.read()
