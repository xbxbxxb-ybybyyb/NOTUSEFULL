...
from System.COLUMN_CONFIG import (FUTURE_TICK_COLUMN_NAMES1, FUTURE_TICK_COLUMN_NAMES2, FUTURE_MINUTE_COLUMN_NAMES,
                                  FUTURE_DAILY_COLUMN_NAMES, FUTURE_TICK_COLUMN_INDEX_DICT1)
...
class FutureDataManager:
    ...
    def __init__(self, libraryName, assetType, underlyingAssetType, startDate, endDate, stockSetTS, stockSetAll,
                 configAnalyzer):
        self.__PRICE_COLUMN_NAMES_1 = ["PreviousClose", "PreSettlePrice", "LastPrice", "OpenPrice", "HighPrice",
                                       "LowPrice", "MaxPrice", "MinPrice"]
        self.__PRICE_COLUMN_NAMES_2 = ["BidPrice", "AskPrice"]
        self.__PRICE_COLUMN_NAMES_4 = ["OpenPrice", "HighPrice", "LowPrice", "ClosePrice"]
        self.__PRICE_COLUMN_NAMES_5 = ["SettlePrice", "OpenPrice", "HighPrice", "LowPrice", "ClosePrice"]
        ...
        self.__tickColumnNames1 = FUTURE_TICK_COLUMN_NAMES1
        self.__tickColumnNames2 = FUTURE_TICK_COLUMN_NAMES2
        self.__minuteColumnNames = FUTURE_MINUTE_COLUMN_NAMES
        self.__dailyColumnNames = FUTURE_DAILY_COLUMN_NAMES
        self.__tickColumnIndexDict1 = FUTURE_TICK_COLUMN_INDEX_DICT1
    ...
    def __updateUATickData(self, date):
        ...
        for ua in self.__UASet:
            data1, data2 = self.__preprocessTickData(ua, startDate, endDate)
