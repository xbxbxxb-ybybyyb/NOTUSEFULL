...
factor_info_path_tmp = depart_sample_path+'factor_info_nn.pkl'
...
'add_capital':74e7,'mode_open':1,'contact':'IC2009','benchmark':'500',\
'name':'QuantMachine500'},\
'5160803':\
{'label_open':True,'label_update':True,'mode_portfolio':1,\
'transaction_time':'0930','captial_fake':80e7,'open_capital':80e7,\
'add_capital':60e7,'mode_open':1,'contact':'IC2009','benchmark':'500',\
'name':'AlphaHunter500'},\
'5160304':\
{'label_open':True,'label_update':True,'mode_portfolio':1,\
'transaction_time':'0930vwap','captial_fake':40e7,'open_capital':40e7,\
'add_capital':23e7,'mode_open':1,'contact':'IF2009','benchmark':'300',\
