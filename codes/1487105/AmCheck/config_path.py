...
data_center_path = data_root_path + '/AlphaDataCenter/'
...
name_map={'0930':'am','1300':'pm','0930vwap':'vwap','0930vwap300':'vwap300','0930lf':'lf','0930hf':'hf'}
model_custom_params = {
        'vwap':{'KerasDeepFM':
...
model_config_dict = {
           'am':[
               ('XgboostRegression','am','0930_1129_re_5d',5,240,True),
               ('LinearRegression','am','0930_1129_re_5d',5,240,True),
               ('DeepFM','am','0930_1129_re_5d',5,240,True)],
           'pm':[
           ...
           'vwap300':[
               ('XgboostRegression','vwap300','vwap_re_5d',5,240,True),
               ('LinearRegression','vwap300','vwap_re_5d',5,240,True),
               ('DeepFM_300','vwap300','vwap_re_5d',5,240,True)],
           'lf':[
...
'add_capital':16e6,'mode_open':1,'contact':'IC','benchmark':'500',\
'name':'AlphaHunter500'},\
'5160304':\
{'label_open':False,'label_update':True,'mode_portfolio':1,\
