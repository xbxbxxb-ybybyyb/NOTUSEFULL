...
#data_center_path = '/data/group/800469/AlphaDataCenter/'
#basic_data_path = data_center_path+'Basic/'
#valid_stock_path='/data/group/800469/AlphaTask/valid_stock/valid_stock/'

#order_path = '/data/user/012620/order/'
#model_root_path = '/data/group/800469/AlphaDataCenter/Department/'
#weight_path = model_root_path+'DailyWeight/'
#name_map={'0930':'am','1300':'pm','0930vwap':'vwap'}
#model_name_map_500 = {
#    'am':['XgboostRegression_0930_1129_re_5d','LinearRegression_0930_1129_re_5d','DeepFM_0930_1129_re_5d'],
# 'pm':['XgboostReg_Model_V1_1300_1459_re_5d','LinearRegression_1300_1459_re_5d','DeepFM_1300_1459_re_5d'],
# 'vwap':['XgboostRegression_vwap_re_5d','DeepFM_vwap_re_5d','LinearRegression_vwap_re_5d']}
#model_name_map_300 = {
#    'am':['XgboostRegression_0930_1129_re_5d','LinearRegression_0930_1129_re_5d','DeepFM_0930_1129_re_5d'],
# 'pm':['XgboostReg_Model_V1_1300_1459_re_5d','LinearRegression_1300_1459_re_5d','DeepFM_1300_1459_re_5d'],
# 'vwap':['XgboostRegression_vwap_re_5d','DeepFM_vwap_re_5d','LinearRegression_vwap_re_5d']}
...
basic_data_path = data_center_path+'Basic/'
order_path = '/data/user/012620/order/'
code_root_path = '/data/user/013546/shipan/'
...
universe_path='/data/group/800469/AlphaDataCenter/PoolManagement/'

transit_path = '/data/group/800469/AlphaDataCenter/Transit/'
hfactor_path = '/data/group/800469/AlphaDataCenter/HFactor/'

depart_sample_path = '/data/group/800469/AlphaDataCenter/Department/DepartSample/'
parquet_path = '/data/user/015518/quant_data/qualified_factor/x_day_lib/latest/'
model_root_path = '/data/group/800469/AlphaDataCenter/Department/'#Experiment/Test300/'
depart_factors_path = '/data/group/800002/alpha_factor/lib/x_factor_lib/'
minute_trade_price_path = '/data/group/800469/AlphaDataCenter/minute_trade_price/'
...
name_map={'0930':'am','1300':'pm','0930vwap':'vwap','0930vwap300':'vwap300'}

#model_config_dict = {
#            'am':[
#                ('XgboostRegression','am','0930_1129_re_5d',5,240)],
#            'pm':[
#                ('XgboostReg_Model_V1','pm','1300_1459_re_5d',5,240)],
#            'vwap':[
#                ('XgboostRegression','vwap','vwap_re_5d',5,240)]
#            }

#('XgbRegTSFourModel','am','0930_1129_re_5d',5,240),

model_config_dict = {
           'am':[
               ('XgboostRegression','am','0930_1129_re_5d',5,240),
               ('LinearRegression','am','0930_1129_re_5d',5,240),
               ('DeepFM','am','0930_1129_re_5d',5,240)],
           'pm':[
               ('XgboostReg_Model_V1','pm','1300_1459_re_5d',5,240),
               ('LinearRegression','pm','1300_1459_re_5d',5,240),
               ('DeepFM','pm','1300_1459_re_5d',5,240)],
           'vwap':[
               ('XgboostRegression','vwap','vwap_re_5d',5,240),
               ('LinearRegression','vwap','vwap_re_5d',5,240),
               ('DeepFM','vwap','vwap_re_5d',5,240)],
           'vwap300':[
               ('XgboostRegression','vwap300','vwap_re_5d',5,240),
               ('LinearRegression','vwap300','vwap_re_5d',5,240),
               ('DeepFM_300','vwap300','vwap_re_5d',5,240)],
           }
...
'add_capital':20e7,'mode_open':1,'contact':'IC','benchmark':'500',\
...
'5160304':\
{'label_open':False,'label_update':True,'mode_portfolio':1,\
'transaction_time':'0930vwap300','captial_fake':40e7,'open_capital':40e7,\
'add_capital':20e7,'mode_open':1,'contact':'IF','benchmark':'300',\
