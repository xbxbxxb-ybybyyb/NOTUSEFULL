...
factor_management_path = config_path.factor_management_path
#config_path.basic_data_path = '/data/group/800469/AlphaDataCenter/Basic/'
factor_help_path = config_path.transit_path + 'factor_intermediate/'
update_factor_help_path = config_path.transit_path + 'update_factor/'
# data_center_path = '/data/group/800469/AlphaDataCenter/'
factor_data_path = config_path.hfactor_path
...
def check_factor_update_success(need_factor_list,f_type,start_date,end_date):
    ...
    is_valid = pd.read_pickle(config_path.basic_data_path+'daily/is_valid.pkl').loc[start_date:end_date]
...
for t in catalog_type:
    ...
    # input
    this_factor_list = ['HF_OverBuy_13h', 'HF_PVVCorrIndusRank_13h', 'HF_PriceDiffRatio_13h', 'HF_RetHHIZscore_13h', 'HF_UpReaturnRealStdZScore_13h', 'HF_UpVolumeSkewSeasonalBias_13h', 'HF_VmL2HmVStdRatio10minBias_13h', 'HF_VmL2HmVStdRatio_13h', 'HF_VolSwing5mToAll_13h', 'HF_VolumeSharpe_13h', 'HF_VolumeStrengthCloseStdBias_13h', 'HF_Vwap2LowLowCorr_13h', 'HF_VwapBollingUp_13h', 'HF_VwapLowVR_13h', 'HF_VwapTailTopTRRatioMin_13h', 'HF_VwapTailVolumeRatio_13h', 'MinCorrAbsRePriceRank2D_13h', 'MinCorrExcessPriceRank_13h', 'MinMaxRet_13h', 'MinPVCorr_13h', 'MinPrePVCorr_13h', 'MinPrePriceAutoCorr_13h', 'MinVRCExcess_13h', 'MinVwapHLRateBetaDelta_13h', 'NormalCloseAmtCorrDecay10d_13h', 'PriceDeviationBias10d_13h', 'PriceSkew_13h', 'PriceUpDownRatio_13h', 'RollingCorrCloseVolume_13h', 'SharpeDuringStdDrop_13h', 'SignedVolume_13h', 'SkewDuringAmountHike_13h']
