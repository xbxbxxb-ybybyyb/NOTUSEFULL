...
#        self._model_path = '/data/user/012620/AlphaDataCenter/Models/'+self._modelname+'/'
        self._model_path = data_root_path+'/AlphaDataCenter/Models/'+self._modelname+'/'
        self._prediction_path = data_root_path+'/AlphaDataCenter/DailyPrediction/vwap/'+self._modelname+'/'
    ...
    def revise_prediction_path(self, test_label):
        self._prediction_path = '/data/user/012620/AlphaDataCenter/DailyPrediction/vwap/XgboostRegression_'+test_label+'/'          
