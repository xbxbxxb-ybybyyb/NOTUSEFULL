...
retrain_flag = True#True #pm train yestaday
...
if predict_label:
    ...
    for model in [Lr_Model(), XgboostReg_Model(),  DeepFM_Model()]:
        ...
        count+=1
#save model
path_model = data_root_path+'/AlphaDataCenter/Models/'
path_model_his = data_root_path+'/AlphaDataCenter/Models_history/%s/' % today
shutil.copytree(path_model,path_model_his,True)  
lm.sendMessage("@Vwap Weekly Updated done,%s" % today_date)