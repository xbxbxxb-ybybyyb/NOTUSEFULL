...
def update_fund_factor(today,start_date='20170101'):
    num_process = 24
    Fundatmental_Factor_Tmp_Path = factor_data_path+'fundamental_tmp/'
    s = FactorData()
    ...
    stock_list = pd.read_pickle(basic_daily_path+'is_valid.pkl').columns.tolist()
    ...
    report_apply_date = pd.read_pickle(basic_daily_path+'report_apply_date.pkl')['20150101':]
