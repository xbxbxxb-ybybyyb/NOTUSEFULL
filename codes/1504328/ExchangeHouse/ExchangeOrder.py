...
class ExchangeOrder:
    ...
    def __repr__(self):
        """"""
        dumpStr = " ExchangerOrder, OrderNo={}, Symbol={}, amount={}, volume={}, lastUpdateTime={}, orderTime={}, setPrice={}, setVolume={}, bsFlag={}, state={}".format(
            self.orderNumber, self.code, self.accMount, self.volume, self.lastUpdateTime, self.orderTime,
            self.setPrice, self.setVolume, self.BSFlag, self.order_state()
        )
