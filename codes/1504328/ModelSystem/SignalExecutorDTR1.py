...
class SignalExecutorDTR1(SignalExecutorBase):
    def __init__(self, positionMgr, riskMgr, counterMgr):
        ...
        self.__order = dict()  # have to reset the dict at the beginning of every tick, key = open/close side, value = (price, volume)
