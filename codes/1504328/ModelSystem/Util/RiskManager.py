...
class RiskManager:
    def __init__(self, STOP_LOSS_PARAM, symbol):
        self.__STOP_LOSS_PARAM = STOP_LOSS_PARAM
        self.__symbol = symbol
        self.__DANGER_LINE_PARAM = 0.198 if self.__symbol.startswith("3") or self.__symbol.startswith("688") else 0.098 # 禁止开仓涨跌幅
