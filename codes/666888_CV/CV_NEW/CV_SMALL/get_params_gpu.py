...
def main():
    absolutePath = "/data/user/666888/cvtriggers2020/pure_800arb/"
    if not os.path.exists(absolutePath):
        os.makedirs(absolutePath)
    # TODO
    combine_5161001 = "/data/user/666888/BT_Results/sources/20191111-20200123_20200205/cv-20191111-20200123_20200205-smallNew-180-800/" 
    # TODO
    param_name = "pure_800arb_0207.json"
    print (param_name)
    params = {}
    day_num = 20
    # TODO
    ...
    # TODO
    pre_param_name = "pure_800arb_0202.json"
