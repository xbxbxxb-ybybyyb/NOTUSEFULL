...
class CVConfig:
    def __init__(self):
        ...
        # 日期
        self.today_str = "20191209"
        self.next_trading_day_str = "20191210"
        self.test_start_date_str = "2019-09-23"
        # self.test_start_date_str = "2019-10-28"
        self.test_end_date_str = "2019-12-06"
