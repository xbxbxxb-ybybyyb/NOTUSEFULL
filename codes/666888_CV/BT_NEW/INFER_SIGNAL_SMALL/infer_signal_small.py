...
from BT_NEW.INFER_SIGNAL_SINGLE.ModelInferHDFS import ModelCNNLSTMLongShort
        ...
        try:
            ...
            for date in daily_prediction:
                if daily_prediction[date]["signals"]:
                    ...
                    factor_data.update_factor_value("AlgoBTSmall1", dt_frame, stock_code, date)
                    # factor_data.update_factor_value("AlgoBTSmall2", dt_frame, stock_code, date)
