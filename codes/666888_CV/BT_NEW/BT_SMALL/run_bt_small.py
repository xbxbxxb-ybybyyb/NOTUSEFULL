...
def run_bt_small(is_cp_signal2share, is_bt_300_500, is_bt_production_signals):
    ...
    for portfolio in trade_portfolio:
        ...
        if is_bt_production_signals:
            ...
            signal_csv_dir = "AlgoProductionSignals"
            trigger_json_dir = '666888/production_triggers/{}/'.format(portfolio)
            with py.open('production_triggers/{}/come_from.json'.format(portfolio), 'rb') as f:
                name = f.read()
                name = json.loads(name)
...
if __name__ == '__main__':
    run_bt_small(is_cp_signal2share=False, is_bt_300_500=True, is_bt_production_signals=True)
    # run_bt_small(is_cp_signal2share=False, is_bt_300_500=False, is_bt_production_signals=True)
    # run_bt_small(is_cp_signal2share=False, is_bt_300_500=False, is_bt_production_signals=False)
