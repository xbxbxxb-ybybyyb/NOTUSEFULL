...
#        validation_y = validation_set[self._label_name]
        ...
        xgb_model = xgb.XGBRegressor (
                    n_estimators=70, nthread=100, min_child_weight = 0.1,reg_alpha = 10, gamma =1.0,
...
suffix = 'sevenmodel_'+date_start+'_'+date_end+'/'
model_config_list= [
            ('Xgb1ModelNoValid','vwap','vwap_re_5d',5,240)
             ]
model_path = ''
