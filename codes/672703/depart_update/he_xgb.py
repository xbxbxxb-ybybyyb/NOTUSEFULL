...
class XGBMulti_Model():
    ...
    def init_model(self):
        ...
        model = XGBClassifier(n_estimators=n_estimators, nthread=30, colsample_bylevel=colsample_bylevel,
                              ...
                              max_depth=max_depth, silent=False, objective=objective, eval_metric=eval_metric)
        return model
    ...
    def get_model(self, sample, factor_list):
        ...
        X_train,y_train,X_valid,y_valid = self.get_train_samples(sample,factor_list,get_valid_sample=True)
