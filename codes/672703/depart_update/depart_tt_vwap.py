...
class LgbReg():
    ...
    def get_model(self, sample, factor_list):
        ...
        for j in range(3):
            ...
            train_sample = this_sample[(this_sample['stock'].isin(train_stocks))]
            valid_sample = this_sample[(this_sample['stock'].isin(valid_stocks))]
            ...
            model = LGBMRegressor(n_jobs=24, num_leaves=64, max_depth=6, learning_rate=0.1, 
                 ...
                 reg_lambda=100,random_state=1605, first_metric_only=True,
...
suffix = 'depart_lgb_ts_stock_'+date_start+'_'+date_end+'/'
model_config_list= [
