...
today_date = s.tradingday(today,-1)[0]
start_date = today_date
end_date = today_date
date_list = s.tradingday(start_date,end_date)
lookback_period_max = 240
retrain_flag = True
root_path = '/data/group/800020/AlphaDataCenter/'
model_config_list= [
            ('XgboostRegression','vwap','vwap_re_1d',1,240),
            ('DeepFM','vwap','vwap_re_1d',1,240),
            ('XgboostRegression','am','0930_1129_re_1d',1,240),
            ('DeepFM','am','0930_1129_re_1d',1,240)
             ]
...
model_config_list= [
            ('XgboostReg_Model_V1','pm','1300_1459_re_1d',1,240),
            ('DeepFM','pm','1300_1459_re_1d',1,240)
             ]
factor_list = pd.read_pickle('/data/group/800020/AlphaDataCenter/Sample/factor_list.pkl')
