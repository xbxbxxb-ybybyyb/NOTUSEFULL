...
model_config_list= [
            ...
            ('CatboostMultiClass_Model_R5d','am','bin_0930_1129_re_5d',5,240)
...
for today_date in test_date_list:
    if datetime.datetime.strptime(today_date,'%Y%m%d').weekday()==4:
        retrain_flag = True 
    else:
        retrain_flag = False 
...
model_config_list= [
            ('CatboostMultiClass_Model_R5d','pm','bin_1300_1459_re_5d',5,240)
             ]
