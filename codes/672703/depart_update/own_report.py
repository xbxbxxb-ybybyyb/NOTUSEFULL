...
suffix = 'own'
model_name_map = {
    'am':['XgboostRegression_0930_1129_re_5d','LinearRegression_industry_0930_1129_re_5d','DeepFM_0930_1129_re_5d','All'],
...
no_pool_model_name_map = {
    'am':['CatboostMultiClass_Model_R5d_bin_0930_1129_re_5d'],
 'pm':['CatboostMultiClass_Model_R5d_bin_1300_1459_re_5d'],
 'vwap':['CatboostMultiClass_Model_V1_bin_vwap_re_1d']}
...
model_list = sorted([m for m in model_list if not m in ['MLP']])
print(model_list)
...
excess_path = '/data/user/013546/DailyReport/excess/'
save_path = '/data/user/013546/DailyReport/'
perform_path = '/data/user/013546/DailyReport/performance/'
act_params = {
...
for e,v in no_pool_model_name_map.items():
    for m in v:
        df = get_act(tmp_predict_path+e+'/'+m+'/','20190102',today).astype(np.float64)
...
config_dict['5160304'] = {
    ...
    'w_path_dict' : 
    {
        '5d_control_size,turnover10%':(0.4,0.5,True),
        '5d_control_size,turnover20%':(0.2,0.5,False)
    },
    'save_perform_path':perform_path+'benchmark_300/',
    ...
    'shipan_conf':{
        'open_date':'20200709','next_open_date':'20200710','start_time':'0930'
    },
...
config_dict['5160503'] = {
   ...
   'save_perform_path':perform_path+'benchmark_500/',
   'backtest_date':['20200101','20190101'],
    'bt_conf':
    {
        'start_time':'0930',
    ...
    'shipan_conf':{
        'open_date':'20200630','next_open_date':'20200701','start_time':'0930'
    },
...
config_dict['5160803'] = {
    ...
    'shipan_conf': {
      'open_date':'20200630','next_open_date':'20200701','start_time':'1300'
    },
     'sim_w':{'0930':('sim_w_am_5160803','simulation_w_am'),'1300':('sim_w_pm_5160803','simulation_w_pm')}
}
sim_w_path = '/data/user/013546/DailyReport/performance/shipan/own_track/shipan_sim_w/'
shipan_stats_path = '/data/user/013546/DailyReport/performance/shipan/own_track/shipan_stats/'
sim_shipan_stats_path = '/data/user/013546/DailyReport/performance/shipan/own_shipan_stats/'
shipan_pf_code =['5160304','5160503','5160803']
o32_path = '/data/user/011477/order/O32/afternoon/'
sim_shipan_w_path = '/data/group/800020/AlphaDataCenter/DailyWeight/'


# In[42]:


shipan_compare = False
...
pdf_maker(save_path, run_path+'compare/' + today + '_QuantMachine日报.pdf','vwap')
pdf_maker(save_path, run_path+'compare/' + today + '_AlphaHunter日报.pdf','hf')
...
ftp.cwd('/Xquant/516/QuantMachine回测跟踪/组内因子日报/')
upload(ftp, today + '_QuantMachine日报.pdf', run_path+'compare/' + today + '_QuantMachine日报.pdf')
upload(ftp, today + '_AlphaHunter日报.pdf', run_path+'compare/' + today + '_AlphaHunter日报.pdf')
ftp.quit()
