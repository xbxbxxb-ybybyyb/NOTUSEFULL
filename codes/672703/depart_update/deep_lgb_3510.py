...
#    label = pd.read_pickle('/data/group/800020/AlphaExperiment/Test/label_vwap_am_keepna.pkl')
    ...
    label['vwap_re_com'] = label[['vwap_re_'+str(i)+'d' for i in [3,5,10]]].mean(axis=1)
...
suffix = 'depart_rank_norm_com_3510'+date_start+'_'+date_end+'/'
model_config_list= [
            ('LgbReg','vwap','vwap_re_com',10,240)
             ]
