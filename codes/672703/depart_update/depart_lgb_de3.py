...
suffix = 'depart_select_factor_drop100_'+date_start+'_'+date_end+'/'
model_config_list= [
            ('LgbReg','am','0930_1129_re_5d',1,240)
             ]
...
'BollingerDown20d', 'ShortBear', 'BollingerUp20d', 
 'ShortBull', 'RankNetProfitDps']+['GTJA_006', 'MTM5d', 'Relative300Return5D', 'RankedReversion', 'VolumePriceKurt120d', 'OprProfitToNP_ttm_tsrank4', 'MinuteCloseVol30mChg', 'AccountPayableTurn_ttm_std_1y', 'PredictReturn2Volume', 'GTJA_029', 'GTJA_063', 'BollingerUp20d', 'alpha53', 'PctChangeMax5d', 'VolumeRatio20d', 'ValueGrowth', 'GTJA_077', 'AccountPayableTurn_ttm_std_3y', 'MinuteDuoKong0', 'GTJA_019', 'MinuteVWAPSortino', 'MinPmRSRS5d', 'MinuteCloseDuoKong', 'MinSkipCorrRatio', 'DownVolatility60d', 'WQ_038', 'Min30_PRchange_1d', 'SwingDays20d', 'EbitdaTTM', 'MinuteLongBear', 'Min5LastHourElder5dSharp', 'GTJA_057', 'MinuteLastHourMtm', 'OprProfitToNP_qfa_tsrank12', 'GTJA_041', 'CurDebtToDebt_yoy', 'CloseLoc', 'ACDIndicator', 'CurDebtToDebt_qoq', 'BP_tsrank8', 'MinuteReturnVolumeMultiple', 'NetCash_surprise', 'Min5LastHourVwapCorrVolume5d', 'AssetTurn_ttm_yoy', 'EbitTTM', 'MinutePMRtnZscore10d', 'GTJA_124', 'DownVolatility20d', 'Max2Min5d', 'ACD6d', 'GTJA_017', 'BP_tsrank4', 'ClosePercentHighLow', 'netprofit_std', 'GTJA_096', 'InventoryTurn_ttm_yoy', 'OprProfitToNP_qfa_tsrank8', 'GTJA_009', 'GTJA_008', 'ClosePercentIndus', 'VolumePriceKurt60d', 'SignedPriceRatio', 'BP_tsrank12', 'Min30_PRchange_5d', 'MinuteCorrReturnVolumeResampled', 'Min_Range_Ratio_1d', 'MinTWAPReSharpe5d', 'MinuteHighPricePos5d', 'CCI10d', 'GTJA_028', 'GTJA_078', 'MinExcessIndusPercent', 'GTJA_076', 'Min_CorrCloseVolume', 'CurDebtToDebt_tsrank8', 'GTJA_003', 'DeltaVwapAdjValid', 'WQ_054', 'DownDayReturn', 'IlliqCv20d', 'CloseDistance2Journey', 'MinUpDownRetAcc', 'GTJA_038', 'GTJA_080', 'GTJA_011', 'AtrDelta5d10d', 'VolumeReversionMultiple', 'GTJA_022', 'MinWR_20_80', 'MinuteCloseNetural', 'GTJA_013', 'LongBear', 'DeltaCloseAdj1d', 'GTJA_085', 'DeltaTurn', 'DeltaVolume', 'GTJA_021', 'MinuteEODRetVolMultipleBias', 'VolumeRatio5d', 'GTJA_002']
