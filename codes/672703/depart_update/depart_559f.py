...
def update_model_predict(root_path='',path_sample=[],factor_list=[],
    ...
    if retrain_flag == True:
        ...
        print('......................')   
    sample_daily = pd.read_pickle(path_feature+today_date+'.pkl')[['date','stock']+factor_list]
...
suffix = 'depart_rank_norm658_'+date_start+'_'+date_end+'/'
model_config_list= [
            ('Lr_Model','vwap','vwap_norm_re_5d',5,240)
             ]
