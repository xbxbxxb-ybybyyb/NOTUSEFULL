...
def update_model_predict(root_path='',path_sample=[],factor_list=[],
    ...
    t = time.time()
    path_feature = '/data/group/800020/AlphaDataCenter/HFSample/NormSample/'
    path_label = '/data/group/800020/AlphaDataCenter/Department/DepartSample/HFSample/label/'
    this_label = pd.read_pickle('/data/user/013546/rubbish/sort_extreme_1300_1459_5d.pkl')
    if retrain_flag == True:
        ...
        training_sample['sort_extreme_1300_1459_5d'] = training_sample['sort_extreme_1300_1459_5d'].fillna(0)
        print('......................')   
...
suffix = 'no_winsard_'+date_start+'_'+date_end+'/'
model_config_list= [
            ('XgboostRegression','pm','sort_extreme_1300_1459_5d',5,240)
             ]
