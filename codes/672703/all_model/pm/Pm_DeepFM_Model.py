...
class DeepFM_Model():
    ...
    def __init__(self):
        ...
        self._model_path = '/data/user/012620/AlphaDataCenter/Models/pm/'+self._modelname+'/'
        self._prediction_path = '/data/user/012620/AlphaDataCenter/Models/pm/'+self._modelname+'/'
        self.NUM_SPLITS = 3
        try:
    ...
    def revise_model_name(self, name):
        self._modelname =  'DeepFM_'+ name
        self._model_path = '/data/user/012620/AlphaDataCenter/Models/pm/'+self._modelname+'/'
        self._prediction_path = '/data/user/012620/AlphaDataCenter/DailyPrediction/pm/'+self._modelname+'/'            
