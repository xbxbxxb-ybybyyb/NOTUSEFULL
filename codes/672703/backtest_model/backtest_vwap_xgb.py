...
model_dict = {'XgboostReg_Model':('vwap_re_135d',5)}
...
for today_date in dates:
    ...
    if retrain_flag == True:
        ...
        training_sample['vwap_re_135d'] = (training_sample['vwap_re_1d']+training_sample['vwap_re_3d']+training_sample['vwap_re_5d']).values/3.
