...
model_dict = {'Lr_Model':('industry_0930_1129_re_5d',5)}
factor_list = pd.read_pickle('/data/group/800020/AlphaExperiment/Test/factor_list.pkl')
path_sample = '/data/group/800020/AlphaExperiment/Test/Sample/'#
