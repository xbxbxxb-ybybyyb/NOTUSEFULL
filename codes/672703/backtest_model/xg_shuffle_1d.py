...
class XgboostReg_Model():
    ...
    def get_model(self, sample, factor_list):
        ...
        for i in range(3):
            ...
            train_dates.append(dates[100:200])
            ...
            for j in range(2):
                ...
                xgb_model = xgb.XGBRegressor (
                        ...
                        min_child_weight = 0.1, max_depth=10, learning_rate=0.1,
                ...
                filename = self._model_path  +'model_'+str(i)+'_'+str(j)+'.pkl'
...
root_model_path = '/data/user/013546/AlphaDataCenter/Models/'+t+'/'+'weekday_t/shuffle2/'
root_predict_path = '/data/user/013546/AlphaDataCenter/DailyPrediction/'+t+'/'+'weekday_t/shuffle2/'
