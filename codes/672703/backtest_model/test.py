...
class XgboostReg_Model_V0():
    ...
    def get_model(self, sample, factor_list):
        ...
        for j in range(4):
            ...
            xgb_model = xgb.train(params, dtrain, num_boost_round=100,evals = [(dtrain,'train'),(dval,'val')] ,verbose_eval=100,maximize=maximize)
...
suffix = 'test1/'
model_config_list= [
            ('XgboostReg_Model_V0','vwap','vwap_re_5d',5,240)
             ]
