...
class XgboostReg_Model():
    ...
    def get_model(self, sample, factor_list):
        ...
        for j in range(4):
            ...
            xgb_model.fit(X=train_x, y=train_y, verbose=False, eval_set=[(validation_x, validation_y)],
    ...
    def label_predict(self, sample_daily, factor_list):
        ...
        prediction = pd.concat(res, axis=1).mean(axis=1)
        return prediction
...
root_model_path = '/data/user/013546/AlphaDataCenter/Models/'+t+'/'+'weekday_t/shuffle_final_mdp8/'
root_predict_path = '/data/user/013546/AlphaDataCenter/DailyPrediction/'+t+'/'+'weekday_t/shuffle_final_mdp8/'
