...
count = 0
lookback_period = 240
root_model_path = '/data/user/013546/AlphaDataCenter/Models/am/'
root_predict_path = '/data/user/013546/AlphaDataCenter/DailyPrediction/am/'
model_dict={'XgboostReg_Model':('0930_1129_re_1d',1),
            'DeepFM_Model':('0930_1129_re_1d',1),
            'Lr_Model':('industry_0930_1129_re_5d',5)}
model_dict = {'DeepFM_Model':('0930_1129_re_1d',1)}
