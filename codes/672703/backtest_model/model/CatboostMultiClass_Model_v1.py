...
class CatboostMultiClass_Model_v1():
    ...
    def __init__(self,params):
        ...
        self.tool_path = '/data/group/800020/AlphaExperiment/catboost_tool/'
    ...
    def get_model(self, sample, factor_list):
        ...
        try:
            ...
            if last_date < dates[-1]:
                test_date = [d for d in dates if d > last_date]
                filename = self._model_path +'model.pkl'
                with open(filename, 'rb') as f:
                    last_model = pickle.load(file=f)
                all_weight = np.load(self.tool_path + 'up_weights.npy').tolist()
