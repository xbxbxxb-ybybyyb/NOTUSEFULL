...
class XgboostReg_Model(): 
    ...
    def get_model(self, sample, factor_list):
        ...
        for j in range(4):
            ...
            params = {'seed':1993,'eta': 0.1,'tree_method':'gpu_hist',
           'gamma': 1.0,'nthread': 100,
              'subsample':0.8,'colsample_bytree':0.7,'reg_alpha':1000,
            ...
            xgb_model = xgb.train(params, train_dmatrix,verbose_eval=False,num_boost_round=1000,maximize=maximize,early_stopping_rounds=100,
...
root_model_path = '/data/user/013546/AlphaDataCenter/Models/'+t+'/'+'test_old/'
root_predict_path = '/data/user/013546/AlphaDataCenter/DailyPrediction/'+t+'/'+'test_old/'
