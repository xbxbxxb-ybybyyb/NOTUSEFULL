...
class XgboostReg_Model():
    ...
    def __init__(self):
        ...
        # self._label_name = 'new_label'
        self._random_seed = 1990
        self._modelname =  'XgboostRegression_'+ self._label_name
        self._model_path = '/data/user/012965/data/model_save/'+self._modelname+'/'
        self._prediction_path = '/data/user/012965/data/activation/Monitor/'+self._modelname+'/'
