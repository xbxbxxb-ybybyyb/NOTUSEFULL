...
retrain_flag = True
if len(test_date_list)==1:
    retrain_flag = False
root_path = '/data/user/013546/AlphaDataCenter/'
model_config_list= [
            ('CatboostMultiClass_Model','vwap','bin_vwap_re_1d',1,240),
            ('MLP_Model','vwap','vwap_re_1d',1,240),
            ('CatboostMultiClass_Model','am','bin_0930_1129_re_1d',1,240),
            ('MLP_Model','am','0930_1129_re_1d',1,240)
             ]
...
model_config_list= [
            ('CatboostMultiClass_Model','pm','bin_1300_1459_re_1d',1,240),
            ('MLP_Model','pm','1300_1459_re_1d',1,240)
             ]
