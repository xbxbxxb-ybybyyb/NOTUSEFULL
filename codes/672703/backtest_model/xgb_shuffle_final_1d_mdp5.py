    ...
    def get_model(self, sample, factor_list):
        ...
        for j in range(4):
            ...
            xgb_model = xgb.XGBRegressor (
                n_estimators=1000, nthread=100, reg_alpha = 1000, gamma =1.0,
...
root_model_path = '/data/user/013546/AlphaDataCenter/Models/'+t+'/'+'weekday_t/shuffle_final_mdp5/'
root_predict_path = '/data/user/013546/AlphaDataCenter/DailyPrediction/'+t+'/'+'weekday_t/shuffle_final_mdp5/'
