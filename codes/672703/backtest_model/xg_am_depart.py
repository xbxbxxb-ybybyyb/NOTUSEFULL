...
print(model_dict)
path_sample = '/data/group/800020/AlphaExperiment/Final_Sample/Sample/'#
dates = [i for i in dates if i>=date_start and i<=date_end]
week_flag = False 

factor_list = pd.read_pickle('/data/group/800020/AlphaExperiment/Final_Sample/depart_factor_list.pkl')
