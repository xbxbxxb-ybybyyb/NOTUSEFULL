...
factor_management_path = '/data/group/800020/AlphaFramework/FactorManagement/hf/'
...
def update_factor_help(f,f_type,start_date,end_date):
    os.system('python3 '+update_factor_code_path+'update_hfactor_single.py '+f+' '+f_type+' '+start_date+' '+end_date)
...
argus={}
argus['start_date'] = '20190816'
argus['end_date'] = '20190816'
...
for t in catalog_type:
    ...
    this_factor_list = ['MinuteEODRetDrawdownRatio']
