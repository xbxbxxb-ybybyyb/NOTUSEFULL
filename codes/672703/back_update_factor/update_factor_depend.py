...
for t in catalog_type:
    ...
    this_factor_list = ['NI_SQ_IndustryRank','ResidualReturn500Sharpe','TyHelp', 'MinCloseCallAmtRatio', 'Atr20d', 'Atr5d', 'Atr10d', 'Atr50d', 'Atr60d', 'MinuteLast30mPriceVolRefine', 'AtrDelta10d20d', 'MPV_EWMASTD', 'CCAREnhancedPVCorrMean20d', 'AtrDelta5d10d', 'AtrDelta10d50d', 'MPV_EWMAHHI', 'TyVolatility', 'AtrDelta20d50d', 'MPV_EWMA', 'AtrDelta20d60d', 'TyDegree', 'CCAREnhancedPVCorr']
