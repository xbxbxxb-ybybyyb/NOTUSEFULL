...
def check_prediction_new(activation, transaction_price='close', transaction_time='0930', transaction_period=1,
    ...
    activation = activation.shift(shift_lag)
...
def get_pct(score,ret):
    ...
    return ret_rank
excess_list = {'pm':('1300',120)}
pkl_path = '/data/user/013546/AlphaDataCenter/Factor/fix_neu_factor/'
...
for t in excess_list:
    ...
    for m in model_list:
        ...
        score,score_sub_bench,ret = check_prediction_new(df, transaction_price='vwap', shift_lag=shift_lag,
