...
sys.path.insert(0,'/data/group/800020/AlphaExperiment/AlphaTool/')
...
data_center_path = '/data/group/800020/AlphaExperiment/'
basic_data_path = data_center_path+'Basic/'
factor_help_path = data_center_path+'Transit/factor_intermediate/'
update_factor_help_path = data_center_path+'Transit/update_factor/'
factor_data_path = data_center_path+'Factor/'
...
for t in catalog_type:
    ...
    # this_factor_list = pd.read_pickle(update_factor_help_path+'factor_dict.pkl')[batch_factor]
    this_factor_list = ['MinSignedAmtPriceDelayDeltaCorrMean', 'MinCorrVolumePrice', 'MinRRC', 'CCAREnhancedPVCorr', 'Min5LastHourElder5dSharp', 'ROE_SQ', 'Min5LastHalfHourVR5dCut', 'PriceBiasZscore60', 'Min5LastHalfHourRVI', 'Min5LastHourVwapCorrVolume5d', 'netprofit_std', 'MinTopVolCorr5D', 'MinSmartFoolRatio', 'MinCorHighVolumeMax10d', 'RetCorrTurnDelayPure', 'MinExcessSharpe5d', 'Min30CEMVbias', 'NetProfitSurprise', 'MinLowToHighUpPower', 'MinCloseCallAmt30maCorr', 'CCAREnhancedPVCorrMean20d', 'CSTurnpureCorrRetSharp', 'MinCloseCallAmtRatio', 'Min5LastHalfHourVRSI10d', 'MinCloseCallAmt5maCorr', 'Min5LastHalfHourVR', 'Min5LastHalfHourVolStd5d', 'Min5LastHourVwapCorrVolume10dSharp', 'MinTVolStd', 'ReCorr20', 'NIGrowthZscore1y', 'Coskew60d', 'Min5LastHourElder20d', 'CSTurnpureCorrRet', 'PriceBiasDividStd60', 'Min5LongShortRatioCut5d', 'MinTWAPExcessSharpe10d', 'Min5LastHourMFI5d', 'DuoKongPV', 'Min30RSRS', 'MinCorrRto5m5dAdj', 'MinHighVolRet', 'MinUpBackSharpe', 'MinVVCorrRank', 'MinVVRankCorrStd']
