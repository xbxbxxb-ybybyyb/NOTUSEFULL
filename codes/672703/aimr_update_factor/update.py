...
update_factor_code_path='/data/group/800020/AlphaExperiment/AlphaTool/'
...
def update_factor_help(f,f_type,start_date,end_date):
    os.system('python3 '+update_factor_code_path+'update_factor_single_add_stock.py '+f+' '+f_type+' '+start_date+' '+end_date)
...
for t in catalog_type:
    ...
    this_factor_list =  ['CCAREnhancedPVCorrMean20d', 'NetProfitSurprise', 'NIGrowthZscore1y', 'CCAREnhancedPVCorr', 'ROE_SQ', 'Coskew60d', 'netprofit_std']
