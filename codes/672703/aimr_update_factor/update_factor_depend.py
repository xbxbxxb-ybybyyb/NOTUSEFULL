...
def update_factor(factor_list,start_date='', end_date=''):
    ...
    pd.to_pickle(factor_update_order,'/data/user/013546/rubbish/factor_update_order.pkl')
...
this_factor_list = list(chain.from_iterable(factor_dict.values()))
today = datetime.date.today().strftime('%Y%m%d')
start_date = '20200820'
end_date = '20200820'
print(start_date,end_date)
if(not 'start_date' in argus.keys()):
    argus['start_date']=start_date
if(not 'end_date' in argus.keys()):
    argus['end_date']=end_date
...
for t in catalog_type:
    ...
    this_factor_list = ['CorrCloseVolumeSharpe', 'CorrDownVolumeSharpe', 'Min15DPVbias', 'Min15mPriceMax', 'Min30CEMVbias', 'Min30RSRS', 'Min30_PRchange_5d', 'Min5LastHourMFI5d', 'Min5LastHourVwapCorrVolume10dSharp', 'Min5LastHourVwapCorrVolume5d', 'MinAbnCorr', 'MinAmtMidChg', 'MinAmtMidSkew', 'MinAmtMidStd', 'MinCEMVskew', 'MinCloseCallAmt30maCorr', 'MinCloseVolumeRank', 'MinCorrVolumePrice10d', 'MinHighVolumeRankCorr20d', 'MinLowToHighUpPower', 'MinPmRSRS5d', 'MinSignedAmtPriceDelayDeltaCorrMean', 'MinSmartFoolRatioMean', 'MinTMcorr', 'MinTVolStd', 'MinTWAPExcessSharpe10d', 'MinUpBackSharpe', 'MinuteUpVar', 'MinuteVARe5d', 'MinuteVAVwapReturnSR5d', 'MinuteVirtualHighLowStdDif5d', 'MinuteVirtualLineUpdownAmt5d', 'MinuteWRVolume']
    this_factor_list = ['TyHelp','TyDegree','TyVolatility','MinCorrVolumeRetUp10d','PVcorrMom','MinSignedAmtPriceDelayDeltaCorrMean']
    this_factor_list = ['DeltaTurnSkew']
