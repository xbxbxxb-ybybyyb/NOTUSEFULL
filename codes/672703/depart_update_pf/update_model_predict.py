...
import sys
sys.path.insert(0,'depart_update_pf/model/')
...
def update_model_predict(today_date,retrain_flag=False,model_type='am'):
    if model_type=='pm':
        update_model_fix_predict(root_path=model_root_path,
            ...
            model_config_list = model_config_dict[model_type])
    else:
