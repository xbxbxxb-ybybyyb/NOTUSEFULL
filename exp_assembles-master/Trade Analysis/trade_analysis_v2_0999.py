...
import sys
from analysis_function_0999 import *
...
os_param = "/data/user/013150/trade_data/backtest/params/param.json"
if os.path.exists(os_param):
    strategy_param = json.load(open("/data/user/013150/trade_data/backtest/params/param.json", "r"))
else:
    print("param path error")
    strategy_param = json.load(open("/data/user/013150/trade_data/backtest/backup202308_v1/params/param.json", "r"))
