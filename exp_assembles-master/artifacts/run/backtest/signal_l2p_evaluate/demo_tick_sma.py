...
if __name__ == '__main__':
    ...
    brain.set_fill_method(fill_param=FillParamSnap(PCT=0.3), fill_price='NEXT_OPEN')
    ...
    # - plotname: 绘图名称
    brain.generate_report(plot=False, plotname="StrategyThisOpen")
    ...
    # Final Portfolio
    # Value: 1004541.2221
    # AvailableCash: 962961.2221
    # StrategyProfitRate: 0.004541222099700093
    # AnnualProfitRate: 0.0275585525066675
    # MaxDrawDown: 0.002993125059922262
