...
class StrategyBase:
    ...
    def run(self):
        ...
        if not self.task_config["data_cache"]:
            ...
            original_datax = pd.read_pickle("/data/user/013150/tmp/original_datax.pkl")
            original_datay = pd.read_pickle("/data/user/013150/tmp/original_datay.pkl")
        ...
        self.tds_ds_train = self.model_mgr.transforme_torch_dataset_ts(window=model_params["window_size"], is_channel_in_front = True)
