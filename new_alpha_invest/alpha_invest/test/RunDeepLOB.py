...
#     get_ipython().system('unzip -n data.zip')
...
dec_data = np.loadtxt('/data/user/013150/alpha_invest/data/Train_Dst_NoAuction_DecPre_CF_7.txt')
dec_train = dec_data[:, :int(np.floor(dec_data.shape[1] * 0.8))]
dec_val = dec_data[:, int(np.floor(dec_data.shape[1] * 0.8)):]

dec_test1 = np.loadtxt('/data/user/013150/alpha_invest/data/Test_Dst_NoAuction_DecPre_CF_7.txt')
dec_test2 = np.loadtxt('/data/user/013150/alpha_invest/data/Test_Dst_NoAuction_DecPre_CF_8.txt')
dec_test3 = np.loadtxt('/data/user/013150/alpha_invest/data/Test_Dst_NoAuction_DecPre_CF_9.txt')
...
tmp_loader = torch.utils.data.DataLoader(dataset=dataset_train, batch_size=2, shuffle=False)
...
def batch_gd(model, criterion, optimizer, train_loader, test_loader, epochs):
    ...
    for it in tqdm(range(epochs)):
        ...
        dt = datetime.now() - t0
        print(
            f'Epoch {it + 1}/{epochs}, Train Loss: {train_loss:.4f},           Validation Loss: {test_loss:.4f}, Duration: {dt}, Best Val Epoch: {best_test_epoch}')
