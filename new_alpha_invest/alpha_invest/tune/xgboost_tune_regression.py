...
def parallel_tune():
    def objective(params):
        ...
        from alpha_invest.trainingpack import xgboost_pack_regression
        xgboost_pack_regression.XGboostPack.run_single_instance(data_params=data_params, model_params=params)
    ...
    config = {
        ...
        'n_estimators': tune.randint(350, 1000),
    ...
    tune.run(objective, config=config, search_alg=optuna_search, num_samples=100, resources_per_trial={'gpu': 0, 'cpu':2},
