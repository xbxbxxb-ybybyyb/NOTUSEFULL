...
class TCN(ModelMananger):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TCN, self).__init__(original_datax, original_datay, model_name, model_root_path="./",)
        # Set logger.
    ...
    def train(
        ...
        # train_dataset.config(fillna_type="ffill+bfill")
        # process nan brought by dataloader
        ...
        valid_loader = DataLoader(
            train_dataset, batch_size=self.batch_size, shuffle=False, num_workers=self.n_jobs, drop_last=True
        )
